...
<section id="{{$posts->first()->postCategory->slug}}">
  <div class="py-60px md:py-20 lg:py-30">
    <div class="container">
      ...
      <!-- services carousel -->
      <div
        class="relative overflow-hidden z-0 after:absolute after:top-1/2 after:-translate-y-1/2 after:left-1/2 after:-translate-x-1/2 after:w-650px after:h-550px after:max-w-2/3 after:max-h-2/3 after:blur-[150px] after:rounded-50% after:bg-gradient-circle-2 after:-z-1 after:opacity-60">
