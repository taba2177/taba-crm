...
class BrandsComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'العلامات التجارية', 'en' => 'Brands'];
    }
    ...
    {
        return 'crm::components.homepage.brand-marque';
    }
