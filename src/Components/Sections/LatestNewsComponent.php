...
class LatestNewsComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'آخر الأخبار', 'en' => 'Latest News'];
    }
    ...
    public function itemFields(): array
    {
        return [
            ...
            FieldFactory::make('date', 'date'),
        ];
    }

    public function bladeView(): string
    {
        return 'crm::components.homepage.latest-news';
    }
