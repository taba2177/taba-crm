...
class ServicesCardsComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'بطاقات الخدمات', 'en' => 'Services Cards'];
    }
    ...
    {
        return [
            'ar' => 'عرض الخدمات كبطاقات',
            'en' => 'Display services as cards',
        ];
    }
    ...
    {
        return 'crm::components.homepage.services';
    }
