...
class ServicesCarouselComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'عرض الخدمات دوّار', 'en' => 'Services Carousel'];
    }
    ...
    {
        return [
            'ar' => 'عرض الخدمات في شريط دوّار',
            'en' => 'Display services in a carousel',
        ];
    }
    ...
    {
        return 'crm::components.homepage.services-carousel';
    }
