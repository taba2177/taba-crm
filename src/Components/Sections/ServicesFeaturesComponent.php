...
class ServicesFeaturesComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'مميزات الخدمات', 'en' => 'Services Features'];
    }
    ...
    {
        return [
            'ar' => 'عرض مميزات الخدمات',
            'en' => 'Display services features',
        ];
    }
