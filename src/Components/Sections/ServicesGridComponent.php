...
class ServicesGridComponent implements SectionComponent
{
    ...
    {
        return ['ar' => 'الخدمات شبكة', 'en' => 'Services Grid'];
    }
    ...
    {
        return [
            'ar' => 'عرض الخدمات في شبكة',
            'en' => 'Display services in a grid layout',
        ];
    }
    ...
    {
        return 'crm::components.homepage.services-grid';
    }
