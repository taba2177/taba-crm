...
class ServicesSwiperComponent implements SectionComponent
{
    use HasTranslatableFields;

    public function key(): string
    {
        return 'services-swiper';
    }

    public function label(): array
    {
        return ['ar' => 'الخدمات سوايبر', 'en' => 'Services Swiper'];
    }
    ...
    {
        return [
            'ar' => 'عرض الخدمات بتمرير سوايبر',
            'en' => 'Display services with swiper',
        ];
    }
    ...
    {
        return 'crm::components.homepage.service-swiper';
    }
