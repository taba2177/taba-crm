...
class SingleViewVisionMissionComponent implements SectionComponent
{
    use HasTranslatableFields;

    public function key(): string
    {
        return 'single-view-vision-mission';
    }

    public function label(): array
    {
        return ['ar' => 'الرؤية والرسالة', 'en' => 'Vision & Mission'];
    }
    ...
    {
        return 'crm::components.homepage.single-view-vision-mission';
    }
