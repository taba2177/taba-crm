...
{
    // The following trait is not defined in the provided code.
    // Assuming you have this custom trait in your project,
    // otherwise, you may need to replace it with a valid one.
    use HasPreview;
