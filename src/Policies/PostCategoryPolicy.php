...
class PostCategoryPolicy
{
     ...
     */
    public function view(Authenticatable $user, PostCategory $postCategory): bool
    {
     ...
     */
    public function update(Authenticatable $user, PostCategory $postCategory): bool
    {
     ...
     */
    public function delete(Authenticatable $user, PostCategory $postCategory): bool
    {
     ...
     */
    public function forceDelete(Authenticatable $user, PostCategory $postCategory): bool
    {
     ...
     */
    public function restore(Authenticatable $user, PostCategory $postCategory): bool
    {
     ...
     */
    public function replicate(Authenticatable $user, PostCategory $postCategory): bool
    {
