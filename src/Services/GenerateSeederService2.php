...
* **For Key-Value Information (e.g., Contact Details):**
    ```php
    ['contact_details' => [
        ['key' => رقم الهاتف', 'value' => ['en' => '', 'ar' => '966557459656']'],
        // button
        ['key' => button_text, 'value' => ['en' => '', 'ar' => 'اتصل بنا']]',
    ]]
    ```
...
class AISiteSeeder extends Seeder
{
  ...
  "name": {
    "en": "Why Choose Us",
    "ar": "لماذا تختار جديان؟"
  },
  "register_in_header": 0,
  "section_component": "features-section",
  "order": 4,
  "description": {
    "en": "Reasons to choose Gedeon services.",
    "ar": "أسباب اختيار خدمات جديان."
  },
  "subtitle": {
    "en": "Reasons to Choose Gedeon",
    "ar": "لماذا تختار مكتب جديان؟"
  },
  "posts": [
    {
      "id": 3,
    ...
    },
    {
      ...
      "order": 0,
      "icon": "heroicon-o-book-open",
      "metadata": {"key":{"en":"","ar":""},"value":{"en":"","ar":""}}
    }
  ]
}
