...
@section('content')
                ...
                <div class="main-slider-one__inner">
                    ...
                    data-owl-options='{"loop": true, "items": 1, "navText": ["<span class=\"icon-right-arrow\"></span><span class=\"icon-right-arrow2\"></span>"], "margin": 0, "dots": false, "nav": true, "animateOut": "slideOutDown", "animateIn": "fadeIn", "active": true, "smartSpeed": 1000, "autoplay": true, "autoplayTimeout": 7000, "autoplayHoverPause": false}'>
                        ...
                        <div class="main-slider-one__single">
                            ...
                            <div class="shape1"><img src="{{ asset("/assets/images/shapes/slider-v1-shape1.png") }}" alt="#"></div>
                            ...
                            <div class="container">
                                <div class="main-slider-one__content text-center">
                                    ...
                                    <div class="title">
                                        <h2> {!! __('services') !!}<br>{!! __('digital_solution') !!}</h2>
                                    </div>
                                    ...
                                    <div class="main-slider-one__content-btn">
                                        <a class="thm-btn" href="{{ url("contact") }}">{!! __('view_services') !!}</a>
                                    </div>
                        ...
                        <div class="main-slider-one__single">
                            ...
                            <div class="shape1"><img src="{{ asset("/assets/images/shapes/slider-v1-shape1.png") }}" alt="#">
                            </div>
            ...
            <section class="intro-one">
                <div class="shape2"><img src="{{ asset("/assets/images/shapes/intro-v1-shape2.png") }}" alt=""></div>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.1s">
                            <div class="intro-one__single">
                                <div class="intro-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset("/assets/images/resources/intro-v1-img1.jpg") }}" alt="#">
                                    </div>
                                    <div class="icon-box">
                        ...
                        <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.2s">
                            <div class="intro-one__single">
                                <div class="intro-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset("/assets/images/resources/intro-v1-img2.jpg") }}" alt="#">
                                    </div>
                                    <div class="icon-box">
                                ...
                                <div class="intro-one__single-content text-center">
                                    <div class="shape1"><img src="{{ asset("/assets/images/shapes/intro-v1-shape1.png") }}" alt="#"></div>
                                    <h2><a href="{{ url("#") }}">{!! __('tech_solution') !!}</a></h2>
                                    <p>{!! __('lorem_ipsum') !!} <br>
                                        {!! __('') !!}</p>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.3s">
                            <div class="intro-one__single">
                                <div class="intro-one__single-img">
                                    <div class="inner">
                                        <img src="{{ asset("/assets/images/resources/intro-v1-img3.jpg") }}" alt="#">
                                    </div>
                                    <div class="icon-box">
            ...
            <section class="about-one">
                <div class="shape5 rotate-me"><img src="{{ asset("/assets/images/shapes/about-v1-shape4.png") }}" alt="#"></div>
                <div class="shape6"><img src="{{ asset("/assets/images/shapes/about-v1-shape5.png") }}" alt="#"></div>
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                            <div class="about-one__content-text3-progress">
                                                <div class="shape2"><img src="{{ asset("/assets/images/shapes/about-v1-shape1.png") }}"
                                                        alt="#"></div>
                                                <div class="shape3"><img src="{{ asset("/assets/images/shapes/about-v1-shape2.png") }}"
                                                        alt="#"></div>
                        ...
                        <div class="col-xl-6">
                            <div class="about-one__img">
                                ...
                                <div class="about-one__img2">
                                    <div class="shape4 rotate-me"><img src="{{ asset("/assets/images/shapes/about-v1-shape3.png") }}"
                                            alt="#"></div>
                                    <ul>
                                        <li>
                                            <div class="img-box1">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6  wow fadeInLeft" data-wow-delay="0ms"
                            ...
                            <div class="services-one__single text-center">
                                <div class="shape2"><img src="{{ asset("/assets/images/shapes/services-v1-shape1.png") }}" alt="#"></div>
                    ...
                    <div class="services-one__bottom text-center">
                        ...
                        <p>{!! __('nemo_enim') !!} <br>
                            {!! __('') !!}</p>
                        <div class="btn-box">
                            <a class="thm-btn" href="{{ url("#") }}">{!! __('more_solution') !!}</a>
                        </div>
                    </div>
            ...
            <section class="video-one">
                <div class="shape1"><img src="{{ asset("/assets/images/shapes/video-v1-shape1.png") }}" alt="#"></div>
                <div class="shape2"><img src="{{ asset("/assets/images/shapes/video-v1-shape1.png") }}" alt="#"></div>
                <div class="container">
                    <div class="video-one__inner">
                        ...
                        <div class="shape3"><img src="{{ asset("/assets/images/shapes/video-v1-shape3.png") }}" alt="#"></div>
                        ...
                        <div class="shop-details__tab tabs-box">
                            <div class="shop-details__tab-button">
                                <ul class="tab-buttons clearfix">
                                    <li data-tab="#one" class="tab-btn active-btn">
                                        <h4>أعمالنا</h4>
                                    </li>
                                    <li data-tab="#tow " class="tab-btn">
                                        <h4>هوية بصرية
                                        </h4>
                                    </li>
                            ...
                            <div class="tabs-content">
                                            ...
                                            <div class="col-xl-4 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                                                <div class="shop-page__single">
                                                    <div class="shop-page__single-img">
                                                        <img src="assets/images/shop/shop-v1-img1.jpg" alt="#">
                                                        <div class="text">عرض</div>
                                                    </div>
                                                    <div class="shop-page__single-content">
                                                        <div class="btn-box text-center">
                                                            <a href="shop-details.html">عرض العمل</a>
                                                        </div>
                                                        <div class="bottom-text">
                                                            <div class="text-box">
                                                                <h4><a href="shop-details.html">موقع فن الستارة</a></h4>
                                                                {{-- <p>$80.00</p> --}}
                                                            </div>
                                ...
                                <!--Start Tab-->
                                <div class="tab active-tab" id="four">
                                    <div class="shop-details__tab-content-item style2">
                                        <div class="row">
                                            <!--Start Shop Page Single-->
                                            <div class="col-xl-4 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="container">
                    <div class="cta-one__inner">
                        ...
                        <div class="cta-one__btn">
                            <a href="{{ url("contact") }}">{!! __('view_protfolio') !!}</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="counter-one">
                ...
                <div class="container">
                        ...
                        <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.1s">
                            <div class="counter-one__single">
                                <div class="counter-one__single-top">
                                    <div class="img-box"><img src="{{ asset("/assets/images/shapes/counter-v1-shape1.png") }}" alt="#">
                                    </div>
                                    <div class="content-box">
                                        <h2><span class="odometer"  dir="ltr" data-count="80">{{ __('00') }}</span> <span class="plus">{!! __('') !!}</span>
                                        </h2>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.2s">
                            <div class="counter-one__single">
                                <div class="counter-one__single-top">
                                    ...
                                    <div class="content-box">
                                        <h2><span class="odometer"  dir="ltr" data-count="50">{{ __('00') }}</span> <span class="plus">{!! __('') !!}</span>
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div class="counter-one__bottom text-center">
                        ...
                        <div class="btn-box">
                            <a class="thm-btn" href="{{ url("contact") }}">{!! __('discover_more') !!} </a>
                        </div>
                    </div>
                </div>
            </section>
