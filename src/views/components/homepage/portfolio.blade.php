          ...
          <div class="absolute bottom-0 left-0 w-full p-15px md:p-30px flex flex-wrap lg:flex-nowrap items-end gap-15px md:gap-5 justify-between z-[2]">
            <div>
              ...
              <h4 class="text-size-25 sm:text-3xl md:text-size-35 lg:text-size-40 xl:text-size-44 font-semibold leading-1.2 sm:leading-1.2 -tracking-0.02em inline-block max-w-580px w-full">
                <a href="#" class="text-white-color hover:text-primary-color dark:hover:text-primary-color transition-all duration-[.8s] inline relative z-0 bg-[0_100%] [background-size:0_2px] bg-no-repeat bg-gradient-primary-3 hover:[background-size:100%_2px]">
                  {{$item->title }}
                </a>
              </h4>
      ...
      <div class="lg:sticky lg:top-[50%] mx-auto lg:h-[calc(100vh-400px)] lg:overflow-y-auto">
        <div class="lg:pl-30px rtl:lg:pr-30px">
          ...
          <div class="mt-30px md:mt-35px wow fadeInUp" data-wow-delay=".6s">
            <a href="#" class="text-size-15 font-bold text-white-color capitalize py-17px px-35px bg-200 bg-gradient-secondary hover:bg-[-100%] rounded-full inline-flex gap-10px items-center leading-1 transition-all duration-300 group wow fadeInRight" data-wow-delay=".5s">
