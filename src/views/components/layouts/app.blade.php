...
<body class="font-sora dark:bg-dark-color overflow-x-hidden relative">
  ...
  <div class="fixed bottom-6 left-6 z-50 flex flex-col space-y-4">
    <a href="https://wa.me/966557459656" target="_blank" class="bg-primary-color hover:bg-primary-color-700 text-white p-4 rounded-full shadow-lg transition-transform duration-300 transform hover:scale-110 animate-bounce-in">
      <svg fill="#ffffff" viewBox="-1.66 0 740.824 740.824" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
    ...
    <a href="tel:+966557459656" class="bg-primary-color hover:bg-primary-color-700 text-white p-4 rounded-full shadow-lg transition-transform duration-300 transform hover:scale-110 animate-shake">
      <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1C10.74 21 3 13.26 3 4c0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.47.57 3.58.12.35.03.74-.25 1.02L6.62 10.79z" />
      </svg>
    </a>
  </div>
