<x-layouts.main :title="$post->title">
    <div class="bg-gray-50 dark:bg-gray-900">
                 @php
                    // It is better to pass this array from the controller.
                    // This array maps post slugs to their corresponding image paths.
                    $productImages = [
                        'american-curtains' => '/images/white-curtains-empty-room.jpg',
                        'wavy-curtains' => '/images/cf79c3c1438932409b19654684dfebc7.jpg',
                        'hospital-curtains' => '/images/82f94f2923421b2f9495a1d9830cb0d8.jpg',
                        'roller-blinds' => '/images/3996e52ddeb206cd92941c06b6bf878c.jpg',
                        'roller-shutter' => '/images/44c7acdae5ad79f18f410f5aa6714d9c.jpg',
                        'motorized-curtains' => '/images/30bfc876d56bf6173b872740ba299acb.jpg',
                        'wooden-blinds' => '/images/72c4fdbe28b889ba08b5ffc37b6067ee.jpg',
                        'metal-blinds' => '/images/61470e17545b917c57bf27cc18829a0b.jpg',
                        'vertical-blinds' => '/images/5a33e3536ef8e7b950ff0422434681f4.jpg',
                        'zebra-blinds' => '/images/4ede506e9b912b4df46db151479a846d.jpg',
                        'roman-blinds' => '/images/3d5e1db089df4f3678c9a6bd6586414c.jpg',
                        'bamboo-blinds' => '/images/1b27288dbbf155450e6ba7d233a1463e.jpg',
                        'plastic-blinds' => '/images/16b9e0988a138f936a9e32042979a09c.jpg',
                        'modern-decor' => '/images/view-futuristic-lighting-lamp-design.jpg',
                        'carpet' => '/images/94d95f8973fbe4033c17780b08b8446a.jpg',
                        'parquet' => '/images/b7d0ac20f54f283d8dc944cdce38ca8c.jpg',
                        'vinyl' => '/images/d4aca0b99088d3391f43a288eee93e38.jpg',
                        'artificial-grass' => '/images/d6d3713c516490f88766446684f34cf5.jpg',
                        'wallpaper' => '/images/f23bd0e4f5a5707888cd46bf753136c5.jpg',
                        'disposable-curtains' => '/images/fdf3897eed4f27eabccaf670495e8eec.jpg',
                        'medical-handrail' => '/images/04d2102a040d5679bfd460b457be465a.jpg',
                        'corner-guard' => '/images/10201899 copy.jpg',
                        'shower-chair' => '/images/fast-fashion-concept-with-full-clothing-store.jpg',
                    ];
                @endphp
        <div class="container py-8 md:py-12">
                <x-breadcrumbs2 :post="$post" :image="$productImages[$post->slug] ?? null" :title="$post->postCategory->description" :items="[
                ...
                <main class="lg:col-span-2 bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-lg shadow-sm">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4">
                            <a href="#"
                                class="text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"><span
                                    class="sr-only">Instagram</span><svg class="w-5 h-5" fill="currentColor"
                                    viewBox="0 0 24 24" aria-hidden="true">
                                    <use xlink:href="#instagram-icon" />
                                </svg></a>
                            <a href="#"
                                class="text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"><span
                                    class="sr-only">Facebook</span><svg class="w-5 h-5" fill="currentColor"
                                    viewBox="0 0 24 24" aria-hidden="true">
                                    <use xlink:href="#facebook-icon" />
                                </svg></a>
                            <a href="#"
                                class="text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"><span
                                    class="sr-only">X/Twitter</span><svg class="w-5 h-5" fill="currentColor"
                                    viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div
                                ...
                                <img src="{{ $productImages[$relatedPost->slug] ?? $relatedPost->getRandomImage() }}"
