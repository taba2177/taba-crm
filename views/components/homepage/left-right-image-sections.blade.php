...
<section id="portfolio"
  class="relative z-0 after:absolute overflow-x-hidden after:top-1/2 after:-translate-y-1/2 after:left-1/2 after:-translate-x-1/2 after:w-650px after:h-550px after:max-w-2/3 after:max-h-2/3 after:blur-[150px] after:rounded-50% after:bg-gradient-circle-2 after:-z-1 after:opacity-60">
      ...
      <div class="flex flex-col gap-50px md:gap-0">
        ...
        <div
          ...
          <div
            ...
            <a href="{{ $post->url ?? '#' }}" class="rounded-15px overflow-hidden">
