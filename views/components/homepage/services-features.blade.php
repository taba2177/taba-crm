          ...
          <div class="w-full max-w-[510px]">
            <div>
              ...
              <div class="mt-35px xl:mt-35px wow fadeInUp" data-wow-delay=".3s">
                <a href="{{  $item->url  }}" class="text-size-15 font-bold text-white-color capitalize py-17px px-35px bg-200 bg-gradient-secondary hover:bg-[-100%] rounded-full inline-flex gap-10px items-center leading-1 transition-all duration-300 group">
