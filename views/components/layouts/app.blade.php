...
<body class="font-sora dark:bg-dark-color overflow-x-hidden relative">
    ...
    <div class="fixed bottom-6 left-6 z-50 flex flex-col space-y-4">
        <a href="https://wa.me/966557459656" target="_blank"
            class="bg-primary-color hover:bg-primary-color-700 text-white p-4 rounded-full shadow-lg transition-transform duration-300 transform hover:scale-110 animate-bounce-in">
        ...
        <a href="tel:+966557459656"
            class="bg-primary-color hover:bg-primary-color-700 text-white p-4 rounded-full shadow-lg transition-transform duration-300 transform hover:scale-110 animate-shake">
