...
<footer class="bg-gray-900 w-full">
    <div class="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            @foreach(collect($menu->items)->groupBy('group') as $group => $items)
            <div class="col-span-1">
                @if($group)
                <h4 class="font-semibold text-gray-100">{{ $group }}</h4>
                @endif
            ...
            <div class="col-span-2">
                ...
                <form>
                    <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-gray-800">
                        ...
                        <button type="submit" class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-sky-600 text-white hover:bg-sky-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                            Subscribe
                        </button>
                    </div>
                </form>
